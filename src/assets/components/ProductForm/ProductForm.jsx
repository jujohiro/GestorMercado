...
const categories = [
  "Granos", "Lácteos", "Dulces", "Carnes", "Limpieza",
  "Bebidas", "Frutas", "Verduras", "Panadería", "Enlatados", "Hogar"
];

const ProductForm = ({ onAddProduct, category }) => {
    ...
    const handleSubmit = (e) => {
      ...
      onAddProduct({ name, brand, price, unit, category, image });
